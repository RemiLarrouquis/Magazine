                            ...
                            <form>
                                ...
                                <div class="form-group row" style="margin-top: 16px;">
                                    ...
                                    <div class="col-sm-6" >
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" readonly="readonly" class="form-control" id="sexe" value="">
                                        </div>
                                    </div>
                                </div>
                                <!-- Row -->
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6" >
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" readonly="readonly" class="form-control" id="nom" value="">
                                        </div>
                                    </div>
                                    <!-- Col -->
                                    <div class="col-sm-6" >
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" readonly="readonly" class="form-control" id="adresse" value="">
                                        </div>
                                    </div>
                                </div>
                                <!-- Row -->
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6" >
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" readonly="readonly" class="form-control" id="prenom" value="">
                                        </div>
                                    </div>
                                    <!-- Col -->
                                    <div class="col-sm-6" >
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" readonly="readonly" class="form-control" id="code_postal" value="">
                                        </div>
                                    </div>
                                </div>
                                <!-- Row -->
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6" >
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" readonly="readonly" class="form-control" id="email" value="">
                                        </div>
                                    </div>
                                    <!-- Col -->
                                    <div class="col-sm-6" >
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" readonly="readonly" class="form-control" id="telephone" value="">
                                        </div>
                                    </div>
                                </div>
                                <!-- Row -->
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6" >
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" readonly="readonly" class="form-control" id="date_naissance" value="">
                                        </div>
                                    </div>
                                    <!-- Col -->
                                    <div class="col-sm-6" >
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" readonly="readonly" class="form-control" id="lieu_naissance" value="">
                                        </div>
                                    </div>
                                </div>
                            </form>
                ...
                <div class="col-xl-4">
                    <div class="card card-primary">
                        ...
                        <div class="card-block" style="width: auto;">
                            ...
                            <button type="button" class="btn btn-secondary btn-lg btn-block">Voir tous les abonnements</button>
